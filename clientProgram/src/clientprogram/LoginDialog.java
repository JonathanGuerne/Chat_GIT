...
public class LoginDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bienvenu dans le Tchat ");
        ...
        jTextAdresse.setText("157.26.110.6");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jTextAdresse, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(190, 324, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        adressIP=jTextAdresse.getText();
        Pattern p = Pattern.compile("[0-9a-zA-Z.]*");
        Matcher m = p.matcher(userName);
        if (m.matches()&&userName.length()<50&&userName.length()>0) {
